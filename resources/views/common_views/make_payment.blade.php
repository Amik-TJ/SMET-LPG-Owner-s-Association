...
@section('content')
    ...
    <div class="container-fluid px-lg-4">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="h3 text-center my-4 text-info">Make Your Payment for Station No : <span class="h2 text-success">{{$station_id}}</span></div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="/make_payment_from_user" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                            <input type="checkbox" class="css-control-input" id="val-terms" name="val-terms" value="1" required> <span class="css-control-indicator"></span>     <span class="text-warning">I agree to the terms</span></label>
                                    </div>
                                </div>
                                <div class="form-group row">

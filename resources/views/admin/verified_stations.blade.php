                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mt-lg-4 mt-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                @if($data['found'])
                                    <h3 class="h2 mb-0 text-gray-800 text-primary font-weight-bold">Verified Stations</h3>
                                @else
                                    <h3 class="h2 mb-0 text-gray-800 text-danger">No Verified Station is available</h3>
                                @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <form action="/delete_station" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="station_id" value="{{$station->station_id}}">
                                                                <input type="hidden" name="from" value="vs">

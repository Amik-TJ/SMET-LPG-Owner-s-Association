                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mt-lg-4 mt-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                @if($data['found'])
                                    <h3 class="h2 mb-0 text-gray-800 text-primary font-weight-bold">Overview of Verified Station Owners</h3>
                                @else
                                    <h3 class="h2 mb-0 text-gray-800 text-danger">No Verified Station Owners</h3>
                                @endif
                                            ...
                                            <table class="table table-striped zero-configuration">
                                                ...
                                                @foreach($data['data'] as $all)
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <form action="/delete_station_owner" method="POST">
                                                                @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="/add_new_station" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="from" id="from" value="vso">
                        {{-------------------------- Title ---------------------}}
